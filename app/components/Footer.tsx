           ...
           <div className="md:hidden">
            ...
            <div className="flex gap-2">
                <input 
                    ...
                    className="w-[206px] bg-white/10 border border-white/10 rounded-[4px] px-4 py-3 text-white placeholder:text-gray-400 focus:outline-none focus:border-[#C84E26]"
                />
