    ...
    return (
        <section className="">
            <div className="max-sm:py-[40px] max-sm:px-4 max-sm:container max-sm:mx-auto max-sm:bg-[#e8e8eb] max-sm:my-[80px]">
                ...
                <h1 className="font-semibold lg:text-[32px] lg:leading-[36px] text-[18px] tracking-[0%] text-center lg:text-[#2B2B2B] lg:text-[#FEFEFE] text-[#2B2B2BCC] lg:pb-[60px] lg:pt-[24px] pt-[18px] pb-[24px]">A legacy of excellence spanning over two decades</h1>
